...
router.get('/dashboard/work', (req, res) => {
    res.render('procurment/work', { title: 'Dashboard' });
});
router.get('/dashboard/service', (req, res) => {
    res.render('procurment/service', { title: 'Dashboard' });
});
